...
{
TTCN_Location current_location("../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn", 47, TTCN_Location::LOCATION_FUNCTION, "f_setVerdict");
current_location.update_lineno(48);
#line 48 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
if ((p__ret == FncRetCode::e__success)) {
current_location.update_lineno(49);
#line 49 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
TTCN_Runtime::setverdict(PASS);
}
else {
current_location.update_lineno(50);
#line 50 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
if ((p__ret == FncRetCode::e__timeout)) {
current_location.update_lineno(51);
#line 51 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
TTCN_Runtime::setverdict(INCONC);
}
else {
current_location.update_lineno(53);
#line 53 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
...
{
TTCN_Location current_location("../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn", 66, TTCN_Location::LOCATION_FUNCTION, "f_setVerdictPreamble");
current_location.update_lineno(67);
#line 67 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
...
#line 68 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
f__setVerdictPreOrPostamble(p__ret);
}

void f__setVerdictPostamble(const FncRetCode& p__ret)
{
TTCN_Location current_location("../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn", 80, TTCN_Location::LOCATION_FUNCTION, "f_setVerdictPostamble");
current_location.update_lineno(81);
#line 81 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
...
#line 82 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
f__setVerdictPreOrPostamble(p__ret);
}

void f__setVerdictPreOrPostamble(const FncRetCode& p__ret)
{
TTCN_Location current_location("../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn", 92, TTCN_Location::LOCATION_FUNCTION, "f_setVerdictPreOrPostamble");
current_location.update_lineno(93);
#line 93 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
if ((p__ret != FncRetCode::e__success)) {
current_location.update_lineno(94);
#line 94 "../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn"
TTCN_Runtime::setverdict(INCONC);
}
}
...
static void pre_init_module()
{
TTCN_Location current_location("../oneM2MTester/AbstractTestSuite/LibCommon/LibCommon_VerdictControl.ttcn", 0, TTCN_Location::LOCATION_UNKNOWN, "LibCommon_VerdictControl");
