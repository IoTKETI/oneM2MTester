...
TTCN_Module module_object("HTTPmsg_Types", __DATE__, __TIME__, module_checksum, pre_init_module, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 0LU, 0, post_init_module, set_module_param, NULL, log_module_param, NULL, NULL, NULL);
...
static void pre_init_module()
{
TTCN_Location current_location("../oneM2MTester/ProtocolModules/HTTP/HTTPmsg_Types.ttcn", 0, TTCN_Location::LOCATION_UNKNOWN, "HTTPmsg_Types");
current_location.update_lineno(25);
#line 25 "../oneM2MTester/ProtocolModules/HTTP/HTTPmsg_Types.ttcn"
modulepar_tsp__socket__debugging = TRUE;
current_location.update_lineno(26);
#line 26 "../oneM2MTester/ProtocolModules/HTTP/HTTPmsg_Types.ttcn"
