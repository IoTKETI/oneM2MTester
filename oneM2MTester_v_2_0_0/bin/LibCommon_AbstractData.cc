...
TTCN_Module module_object("LibCommon_AbstractData", __DATE__, __TIME__, module_checksum, pre_init_module, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 1LU, xml_namespaces, post_init_module, NULL, NULL, NULL, NULL, NULL, NULL);
...
{
TTCN_Location current_location("LibCommon_AbstractData.ttcn", 52, TTCN_Location::LOCATION_FUNCTION, "f_initStringStack");
current_location.update_lineno(53);
/* LibCommon_AbstractData.ttcn, line 53 */
p__stack = c__initStringStack;
}

BOOLEAN f__isStringStackEmpty(StringStack& p__stack)
{
TTCN_Location current_location("LibCommon_AbstractData.ttcn", 61, TTCN_Location::LOCATION_FUNCTION, "f_isStringStackEmpty");
current_location.update_lineno(63);
/* LibCommon_AbstractData.ttcn, line 63 */
...
/* LibCommon_AbstractData.ttcn, line 64 */
return FALSE;
}
}
...
{
TTCN_Location current_location("LibCommon_AbstractData.ttcn", 75, TTCN_Location::LOCATION_FUNCTION, "f_isItemOnStringStack");
...
/* LibCommon_AbstractData.ttcn, line 84 */
return FALSE;
}

BOOLEAN f__peekStringStackTop(StringStack& p__stack, CHARSTRING& p__item)
{
TTCN_Location current_location("LibCommon_AbstractData.ttcn", 95, TTCN_Location::LOCATION_FUNCTION, "f_peekStringStackTop");
p__item.clean_up();
current_location.update_lineno(98);
/* LibCommon_AbstractData.ttcn, line 98 */
if ((const_cast< const StringStack&>(p__stack).stackSize() == 0)) {
current_location.update_lineno(99);
/* LibCommon_AbstractData.ttcn, line 99 */
p__item = cs_0;
...
/* LibCommon_AbstractData.ttcn, line 102 */
...
/* LibCommon_AbstractData.ttcn, line 103 */
return TRUE;
}

void f__pushStringStack(StringStack& p__stack, const CHARSTRING& p__item)
{
TTCN_Location current_location("LibCommon_AbstractData.ttcn", 114, TTCN_Location::LOCATION_FUNCTION, "f_pushStringStack");
current_location.update_lineno(116);
/* LibCommon_AbstractData.ttcn, line 116 */
p__stack.stringItems()[const_cast< const StringStack&>(p__stack).stackSize()] = p__item;
current_location.update_lineno(117);
/* LibCommon_AbstractData.ttcn, line 117 */
{
INTEGER tmp_6;
...
{
TTCN_Location current_location("LibCommon_AbstractData.ttcn", 126, TTCN_Location::LOCATION_FUNCTION, "f_popStringStack");
current_location.update_lineno(127);
/* LibCommon_AbstractData.ttcn, line 127 */
if ((const_cast< const StringStack&>(p__stack).stackSize() > 0)) {
current_location.update_lineno(128);
/* LibCommon_AbstractData.ttcn, line 128 */
{
INTEGER tmp_7;
...
/* LibCommon_AbstractData.ttcn, line 131 */
...
/* LibCommon_AbstractData.ttcn, line 42 */
